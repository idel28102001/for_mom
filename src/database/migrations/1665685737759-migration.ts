...
export class migration1665685737759 implements MigrationInterface {
    name = 'migration1665685737759'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "signups" ADD "duration" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "signups" DROP COLUMN "type"`);
        await queryRunner.query(`DROP TYPE "public"."signups_type_enum"`);
        await queryRunner.query(`ALTER TABLE "signups" ADD "type" character varying NOT NULL`);
    }
